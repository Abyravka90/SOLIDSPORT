...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Feb 2021 pada 04.55
...
(1, 'ALIF LANGIT RAMADHAN ', 'USIA DINI PUTRA', ' PREDATOR KARATE CLUB', 'HEIAN YONDAN ', 'A1', 'Ao', 1, 'standby'),
...
(1, '-', '-', '-', '-', '-', '-', '-', 'J-1', 0, 0, 'standby', 0, 0),
(2, '-', '-', '-', '-', '-', '-', '-', 'J-2', 0, 0, 'standby', 0, 0),
(3, '-', '-', '-', '-', '-', '-', '-', 'J-3', 0, 0, 'standby', 0, 0),
(4, '-', '-', '-', '-', '-', '-', '-', 'J-4', 0, 0, 'standby', 0, 0),
(5, '-', '-', '-', '-', '-', '-', '-', 'J-5', 0, 0, 'standby', 0, 0);
...
--
ALTER TABLE `atlet`
  MODIFY `idAtlet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
